...
const Rate = () => {
  ...
  return (
    <>
      ...
      <div className="Rate_Page_Bottom">
        <p className="head">*Currency and TC's are subject to availability</p>
        <p className="desc">
          ** Forex card amount must be 80% or more of the order total. Forex
          card rate will remain the same as shown above. To book a currency +
          card combo please request a call back *** Transfers processed under
          maintenance and GIFT purposes will be subject to additional charges
        </p>
        <p className="solid">
          Today's Live Currency Exchange Rate Card/ Forex Rates{" "}
        </p>
        <p className="desc">
          A currency rate card basically reflects buy or sell rates of various
          currencies in terms of the home currency. So if you want to check
          Brithish Pound rate in India in terms of Indian Rupee, you can check
          the live rates by visiting the currency rate card. This article aims
          to explain concepts related to exchange rates in India along with the
          currency rate card.
        </p>
        <p className="solid">What is the exchange rate or forex rates?</p>
      </div>
