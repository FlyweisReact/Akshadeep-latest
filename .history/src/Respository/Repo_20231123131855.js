...
const upload_Documents = async (id, payload, purpose, navigate) => {
  try {
    ...
    if (purpose === "Education Abroad") {
      ...
      navigate(`https://www.cashfree.com/?utm_campaign=cf_brandsearch_core&utm_source=googleads&utm_medium=cpc&utm_content=382785299182&utm_term=cashfree&utm_adgroup=cf_brandsearch_core_exact&device=c&utm_matchtype=e&gad_source=1&gclid=Cj0KCQiA6vaqBhCbARIsACF9M6k3KLkz2KWaNLoXejs4JbwbTVL7hxf8AMcrognAS--hHUegIwZGyagaAsqBEALw_wcB`);
    }
    Store.addNotification({
      title: "",
      message: "Submitted",
