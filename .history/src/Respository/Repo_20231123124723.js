...
export const total_charge_bifurcation = async (id , formPayload , setResponse) => {
  try{
    const res = await axios.put(`${localhost}wireTransferr/updatebifurcation/6551cd86ac05681c8acb5965`)
  }catch{}
