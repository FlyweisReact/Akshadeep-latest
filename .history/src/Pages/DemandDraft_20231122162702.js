...
const DemandDraft = () => {
  ...
  return (
    <>
      ...
      <MyVerticallyCenteredModal3 show={show3} onHide={() => setShow3(false)} />
      <div className="currency_Container">
        <div className="Form_Container">
          ...
          <div className="main2-bot-cont">
            <button onClick={() => setLoginSt(true)}>BOOK THIS ORDER</button>
          </div>
        </div>
      </div>
      ...
      <div className="convertor_three_component">
        ...
        <div>
          <img src={img5} alt="" />
          <button onClick={() => setShow3(true)}>Request Better Rate</button>
        </div>
      </div>
