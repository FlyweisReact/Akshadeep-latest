...
import { pan_Validation, RemitterDetail, upload_Documents } from "../Respository/Repo";
            ...
            <div className="four_sec">
              <div className="first">
                ...
                <select>
                  ...
                  <option> Job card issued by NREGA signed by State Government Office  </option>
                  <option> Driving License  issued by Regional Transport Authority  </option>
                  <option> Voter ID  </option>
                  <option> Letter from National Population Register  </option>
                  <option> Proof of possession of Aadhaar </option>
                </select>
              </div>
              <div className="first">
