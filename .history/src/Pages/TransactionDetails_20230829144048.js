...
const TransactionDetails = () => {
  ...
  const documentHandler = (e) => {
    e.preventDefault();
    upload_Documents(id, documentPayload);
  };
            ...
            <div className="four_sec">
              <div className="first">
                ...
                <select onChange={(e) => setDocumentName(e.target.value)}>
                  ...
                  <option value='Letter from National Population Register'> Letter from National Population Register </option>
                  <option value='Proof of possession of Aadhaar'> Proof of possession of Aadhaar </option>
                </select>
              </div>
              <div className="first">
                <p>Documents Number:</p>
                <input type="text" onChange={(e) => setDocumentNumber(e.)} />
              </div>
              <div className="first">
                <p>City</p>
                <select>
