...
const TransactionDetails = () => {
  ...
  const documentPayload = {
    ...
    documentNumber,
    city,
    purposeOfIssue : panResponse?.descPurpose,
    dateOfIssue,
    countryOfIssue : panResponse?.nationalityRemitter,
  };

  const documentHandler = async () => {
    await upload_Documents(id, documentPayload , panResponse?.descPurpose , navigate);
  };
