...
import { all_currencies, foriegn_currency_convertor, get_all_types } from "../Respository/Repo";
...
const ForeignCurrency = () => {
  ...
  const fromCurrency = fixedCountry?.[0]?._id;
  ...
  useEffect(() => {
    foriegn_currency_convertor(convertor_payload , )
  },[])
