  ...
  return (
    <>
      ...
      <p className="head">*Currency and TC's are subject to availability</p>
        <p className="desc">** Forex card amount must be 80% or more of the order total. Forex card rate will remain the same as shown above. To book a currency + card combo please request a call back
 *** Transfers processed under maintenance and GIFT purposes will be subject to additional charges</p>
 <p className="solid">Today's Live Currency Exchange Rate Card/ Forex Rates </p>
      </div>
    </>
  );
};
