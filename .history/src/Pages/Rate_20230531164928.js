  ...
  return (
    <>
      ...
      <p className="head">*Currency and TC's are subject to availability</p>
        <p>** Forex card amount must be 80% or more of the order total. Forex card rate will remain the same as shown above. To book a currency + card combo please request a call back
