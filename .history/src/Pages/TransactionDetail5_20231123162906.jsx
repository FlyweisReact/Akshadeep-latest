...
import { passenger_detail_foriegncurrency } from "../Respository/Repo";
    ...
    <>
      ...
      {step === 2 ? (
        <>
          <div className="transaction_details">
            ...
            <div className="four_sec mb-3">
              ...
              <div className="first">
                ...
                <input
                  type="text"
                  onChange={(e) => setForexCard(e.target.value)}
                />
              </div>
          ...
          <button className="transaction_center_btn" onClick={() => } >Continue</button>
        </>
      ) : (
        ""
      )}
