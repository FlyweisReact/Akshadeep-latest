      ...
      <div className="Index_testimonial_Slider">
        ...
        <Slider {...settings} className="Slider_Cont">
          ...
          <div>
            <img
              src={
                "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR72aEsvFKoRJpfaWB4G1ftrlpe8tN5O6rPhigr1s7UmPYWxH3PeYE2Z1Gqmv8VnT8qtsc&usqp=CAU"
              }
              alt=""
            />
          </div>
          <div>
            <img
              src={
                "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQj1XCuBjTSrvPgRK1cKpsGkdJsxjZzDBzR9Kaxund13Bumhryr2rGjdt10XtlMD3neFzY&usqp=CAU"
              }
              alt=""
            />
          </div>
