...
const Index = () => {
  ...
  const data = [
    {
        title : "Loren Ipsum Id best Platform out there" , 
        text : "It has been close to a decade since Loren Ipsum is assisting me in all my Forex needs. What an incredible journey it has been with Loren ipsum. "
    }
  ]
