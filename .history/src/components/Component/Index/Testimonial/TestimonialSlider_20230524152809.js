    ...
    <>
      <div className="Index_testimonial_Slider">
        ...
        <Slider {...settings} className="Slider_Cont">
            ...
            <div  >
              <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQj1XCuBjTSrvPgRK1cKpsGkdJsxjZzDBzR9Kaxund13Bumhryr2rGjdt10XtlMD3neFzY&usqp=CAU' alt=""  className={activeIndex === 0 ? 'active-slide' : ''}  />
              <div className="stars">
            ...
            <div  >
              <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQj1XCuBjTSrvPgRK1cKpsGkdJsxjZzDBzR9Kaxund13Bumhryr2rGjdt10XtlMD3neFzY&usqp=CAU' alt="" className={activeIndex === 1 ? 'active-slide' : ''}  />
              <div className="stars">
                <i className="fa-solid fa-star"></i>
                <i className="fa-solid fa-star"></i>
                <i className="fa-solid fa-star"></i>
            ...
            <div  >
              <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQj1XCuBjTSrvPgRK1cKpsGkdJsxjZzDBzR9Kaxund13Bumhryr2rGjdt10XtlMD3neFzY&usqp=CAU' alt=""  className={activeIndex === 2 ? 'active-slide' : ''}  />
              <div className="stars">
                <i className="fa-solid fa-star"></i>
                <i className="fa-solid fa-star"></i>
                <i className="fa-solid fa-star"></i>
            ...
            <div  >
              <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQj1XCuBjTSrvPgRK1cKpsGkdJsxjZzDBzR9Kaxund13Bumhryr2rGjdt10XtlMD3neFzY&usqp=CAU' alt=""  className={activeIndex === 3 ? 'active-slide' : ''}  />
              <div className="stars">
                <i className="fa-solid fa-star"></i>
                <i className="fa-solid fa-star"></i>
                <i className="fa-solid fa-star"></i>
