        ...
        <div className="Form_Container">
          ...
          <div className="form-part-2">
            <div className="row1">
              <div className="col1">
                <select className="ip" id="timezone" name="timezone" required>
                  <option> <i class="fa-solid fa-user"></i> Select City</option>
                  <option value="EST">Germany</option>
                  <option value="CST">Brazil</option>
                  <option value="PST"> <i class="fa-solid fa-user"></i> USA</option>
            ...
            <div className="row1">
              ...
              <div className="col1">
                <a className="col1-add">
                  + <spam>AddProduct</spam>
                </a>
              </div>
            </div>
            <div className="row1">
