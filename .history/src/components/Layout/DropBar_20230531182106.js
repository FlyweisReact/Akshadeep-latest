...
import CategoryOff from "./CategoryOff";
    ...
    <>
      <section className="Drop-Category-Bar">
        ...
        <div className="right-Container">
          <button className="Expolre_Btn" onClick={() => setOffShow(true)} >Explore More</button>
          {Records.map((i, index) => (
            <Dropdown key={index}>
      ...
      <CategoryOff show={offShow} setShow={setOffShow} />
    </>
  );
};
