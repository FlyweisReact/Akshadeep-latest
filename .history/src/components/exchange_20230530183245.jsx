...
import img5 from "../Images/button_after -2.png";import img7 from "../Images/h3_before.png";
  ...
  return (
    <>
     ...
     <div className="Currency_Exchange">
          ...
          <p className="desc">
          As an online foreign exchange marketplace, Loren ipsum provides the best USD to INR conversion in contrast to traditional alternatives, such as banks and local authorized money changers.
          </p>
