    ...
    <>
      ...
      <BrowserRouter>
        <Routes>
          ...
          />
          <Route
            path="/Transaction-Details-4"
            element={<TransactionDetail4 />}
          />
          <Route
            path="/Transaction-Details-5/:id"
            element={<TransactionDetail5 />}
          />
          <Route
            path="/Transaction-Details-6"
            element={<TransactionDetail6 />}
          />
